...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main_bookstore', '0008_auto_20211127_1755'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postfix_for_value', models.CharField(blank=True, help_text='Например для характеристики "Кол-во страниц" к значению можно добавить постфикс "страниц", и как результат - значение "10 страниц"', max_length=20, null=True, verbose_name='Постфикс для значения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_bookstore.category', verbose_name='Категория')),
                ('feature', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main_bookstore.productfeatures', verbose_name='Характеристика')),
            ],
        ),
    ]
